...
class ResCompany(models.Model):
	...
	account_retur_credit_id = fields.Many2one('account.account', string="Hutang Retur Pembelian Credit (CR)")	
	...
	account_retur_debit_id = fields.Many2one('account.account', string="Piutang Retur Penjualan Credit (DB)")	
