...
class PenjualanReport(models.Model):
	_name = "penjualan.report"
	_description = "Penjualan Statistics"
	_auto = False
	...
	gbr_category_id = fields.Many2one('res.partner.category',string="Kategori")
	# pelanggan = fields.Char(string='Pelanggan', readonly=True)
	# penjualan dan penjualan eceran
	...
	def _select(self):
		return '''
			SELECT
				...
				move.is_penjualan,
				move.is_penj_eceran,
				partner.gbr_category_id 									AS gbr_category_id,
